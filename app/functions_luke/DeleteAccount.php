  ...
  <body>
    <?php
		...
		$sql = "INSERT INTO customer 
				(account_name, account_password, address, customer_id, customer_region, email, name, phone_number, product_count) 
				VALUES
				('$_POST[username]', '$_POST[password]', '$_POST[address]', '$id', '$_POST[region]', 
